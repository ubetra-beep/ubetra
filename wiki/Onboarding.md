...
![Sub joining with invite code](images/30-sub-onboarding-join.png)

---

## 2. Shared AI key

![AI key step](images/03-onboarding-api.png)
...
![SPTI step](images/04-onboarding-spti.png)
...
![Kink survey prompt](images/05-onboarding-kinks.png)
...
![Kink list](images/22-kink-list.png)  
![Kink list (full categories)](images/07-dom-home-dynamic.png)
...
![Finish](images/06-onboarding-finish.png)

You’ll see your **invite code** to send to your partner. Then open the dynamic overview.

![Dom dynamic overview](images/10-dynamic-overview.png)
